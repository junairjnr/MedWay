...
export const siteContent = {
  promo: [
    { label: "BUY NOW, PAY LATER.", sub: "Financing Options Available" },
    { label: "CANADA WIDE SHIPPING", sub: "Free Shipping on Orders Above $100*" },
    { label: "Sign Up to Our Newsletter", sub: "Get offers and promotions in your mailbox" },
  ],
  heroSlides: [
    {
      badge: "Summer Scooter Sale",
      title: "Foxtr Auto-Fold Scooter",
      price: "Was $4,999 · Now $3,499",
      note: "* Sale on while supplies last",
      cta: "Shop & Save",
      href: "/products/foxtr-auto-fold-scooter",
      image: vitalImages.hero.foxtrSale,
    },
    {
      badge: "Canada's Top Lift Chair Brands",
      title: "In-Stock & Up To 30% OFF",
      price: "",
      note: "",
    ...
    {
      badge: "Hospital Beds for Home Care",
      title: "Shop our exclusive Symphony, VitalFlex and more",
      price: "Canada's top selling Homecare Beds",
      note: "",
      cta: "Shop Now",
  ...
  promoBanners: [
    {
      title: "Summer Scooter Sale",
      subtitle: "FOXTR AUTO FOLDING SCOOTER",
      price: "WAS $4990 - NOW $3490",
      href: "/products/foxtr-auto-fold-scooter",
      image: vitalImages.hero.foxtrSale,
    },
    {
      title: "Canada's Top Lift Chair Brands",
      subtitle: "In-Stock & Up To 30% OFF",
      href: "/categories/lift-chairs",
      image: vitalImages.hero.liftChairs,
    },
    {
      title: "Hospital Beds for Home Care",
      subtitle: "Shop our exclusive Symphony, VitalFlex and more of Canada's top selling Homecare Beds",
      href: "/categories/hospital-beds",
      image: vitalImages.hero.hospitalBeds,
    },
  ],
  intro: {
    eyebrow: "Canada's Trusted Home Health Care & Mobility Experts",
    headline: "Canada's Leading Medical Equipment Supplier & Rental Company",
  ...
  trust: {
    ...
    paragraphs: [
      ...
      "Whether you're a medical professional assisting patients in a healthcare setting or an individual seeking essential medical supplies for yourself or a loved one, we've got you covered. Best of all, our products are backed by our unwavering commitment to quality and customer satisfaction.",
    ],
  },
  cta: {
    ...
    paragraphs: [
      ...
      "Our Toronto-based team is the medical equipment supplier of choice for countless individuals, institutions and professionals across Canada. We ship our quality, branded and trusted medical equipment from coast to coast. Likewise, when a medical equipment rental is needed, Med Way can quickly deliver, unbox and set-up home health care product rentals in Toronto and the Greater Toronto Area (GTA). Our expert technicians provide professional and expeditious service whether you choose to buy or rent medical equipment.",
      "As Canada's independent and trusted industry leader, Med Way is a home health care product supplier of the world's best medical equipment supplies companies and mobility equipment distributors- including Pride Mobility, Invacare, VitalFlex, Rotec, FOXTR Mobility, Mobb, Sunrise Medical, Drive and more. Whether you're looking for a medical equipment rental or medical equipment supplies, our company stands out by stocking a wide selection of hospital beds, mobility scooters, lift chairs and more – making them immediately available for shipping or delivery.",
