...
export const resources = [
  {
    ...
    content: [
      ...
      "Weight capacity, battery range, portability, and ease of disassembly are critical factors. For travel, consider auto-folding models. For everyday outdoor use, full-size scooters offer extended range and comfort.",
      "Visit our showrooms, give us a call or shop online with total confidence — our team will help you find the right mobility solution.",
    ],
  },
  {
    ...
    content: [
      ...
      "Key specifications to review include seat width and depth, weight capacity, turning radius, and portability. Our mobility experts can help you compare options and choose the right fit.",
    ],
  },
  {
    ...
    content: [
      ...
      "Creating a safe home environment starts with the right equipment. Hospital beds like the Elite and Symphony models provide comfort and positioning for long-term care. Bathroom safety products including grab bars, shower chairs, and transfer benches reduce fall risk.",
